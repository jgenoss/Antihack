/**
 * AntiCheatCore - Common Internal Definitions
 * Shared types and utilities for internal use
 */

#pragma once

#ifndef AC_INTERNAL_COMMON_H
...
inline uint32_t CalculateCRC32(const ByteVector& data) {
